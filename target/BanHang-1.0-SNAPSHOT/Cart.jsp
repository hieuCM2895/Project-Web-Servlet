                                            ...
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="sub?id=${o.id}"><button style="border: none; cursor: pointer; border-radius: 2px;" class="btnSub">-</button></a>
                                                        <strong>${o.amount}</strong>
                                                        <a href="cart?id=${o.id}"><button style="border: none; cursor: pointer; border-radius: 2px;" class="btnAdd">+</button></a>
                                                    </td>
                                                    <td class="align-middle"><a href="#" class="text-dark">
                                                            <form action="remove" method="post">
                                                                <button name="id" value="${o.id}" type="submit" class="btn btn-danger">Delete</button>
                                                            </form>
                                                        </a>
                                                    </td>
                                                </tr> 
